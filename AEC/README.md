...
1. 
**Altair AI Studio (RapidMiner):** Utilizado para a componente de *Visual Data Science*, nomeadamente para análise estatística avançada, cálculo de matrizes de correlação visual e extração de regras de associação (FP-Growth).
